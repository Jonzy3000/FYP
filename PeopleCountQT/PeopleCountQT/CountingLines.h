...
typedef std::shared_ptr<CalibrationOptions::CountingLinesConfig> CountingLinesConfigPtr;
typedef CalibrationOptions::CountingLinesConfig::ORIENTATION ORIENTATION;
